<?php
  ...
  foreach($recetas as $receta){
    if ($receta['id'] != $id && $receta['nombre'] != $nombre && $receta['imagen'] != $imagen && $receta['descripcion'] != $descripcion) {
      unset($receta);
    }
  }
        ...
        <div class="product-item-title d-flex">
          <div class="bg-faded p-5 d-flex ml-auto rounded">
            <h2 class="section-heading mb-0">
              ...
              <span class="section-heading-lower"><?php echo $_GET['nombre']; ?></span>
            </h2>
          </div>
        </div>
        <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="img/<?php echo $_GET['imagen']; ?>.jpg" alt="">
                ...
                <?php
                  ...
                  $resultado = mysqli_query($conexion, 'SELECT * FROM comentarios');
                      if (mysqli_num_rows($resultado) > 0) {
                        ...
                        while($comentario = mysql_fetch_assoc($resultado)){
                  ?> 
                    <hr>
                   <div class="container">
